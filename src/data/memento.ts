...
export const memento: Section[] = [
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'liste', items: [
        ...
        'Un clic sur la flèche à droite affiche les actions rapides du module (ex. « Nouvelle mission vierge », « Profils & habilitations », « Plan comptable SYSCOHADA »).',
      ] },
  ...
  },
  {
    ...
    blocs: [
      ...
      { type: 'p', texte: 'Pour un nouveau client ou un premier exercice audité. On peut créer un nouveau dossier client ou choisir un client déjà enregistré. Aucune donnée n’est reprise. Lancée depuis la page d’un dossier client (« Nouvelle mission »), l’assistant s’ouvre directement sur l’étape Client & mission avec ce client présélectionné.' },
  ...
  },
  {
    ...
    resume: 'Les entités auditées et leur historique de missions.',
    blocs: [
      { type: 'p', texte: 'Un dossier client regroupe l’identité d’une entité (raison sociale, sigle, forme juridique, RCCM, NIF/NINEA, dirigeant, siège, activité) et toutes ses missions. Il est créé automatiquement avec la première mission, ou à l’avance avec « Nouveau client ».' },
      { type: 'liste', items: [
        'La liste se filtre par raison sociale, sigle, RCCM, NIF ou activité ; elle affiche le nombre de missions et la dernière mission (exercice et statut).',
        'Un clic sur un client ouvre sa page : identité à gauche, missions à droite (un clic sur une mission ouvre sa page).',
        '« Modifier » met à jour l’identité : la modification vaut pour toutes les missions du client.',
        '« Nouvelle mission » lance l’assistant avec ce client déjà sélectionné.',
        'Un dossier ne peut être supprimé que s’il n’a aucune mission.',
      ] },
    ],
  },
  {
    id: 'parametrage',
    titre: 'Paramétrage',
    resume: 'Informations du cabinet et référentiel comptable.',
    blocs: [
      { type: 'h', texte: 'Informations du cabinet' },
      { type: 'p', texte: 'Nom, sigle, n° d’inscription à l’Ordre, coordonnées, exercice de travail et associé signataire principal. Les modifications sont appliquées avec « Enregistrer » (« Annuler » revient aux valeurs enregistrées).' },
      { type: 'liste', items: [
        'Le nom et l’exercice de travail s’affichent sur le tableau de bord et dans le menu.',
        'Le signataire s’affiche dans la barre d’état ; il est choisi parmi les collaborateurs actifs dont le profil a l’habilitation « Signer les rapports » (Associé signataire, Administrateur…).',
      ] },
      { type: 'h', texte: 'Plan comptable SYSCOHADA' },
      { type: 'p', texte: 'Référence en lecture des 9 classes du SYSCOHADA révisé et de leurs comptes principaux (2 chiffres), avec l’état auquel ils se rattachent (bilan, résultat, hors bilan). Cliquez sur une classe pour la déplier ; la recherche accepte un numéro (ex. 41) ou un libellé (ex. caisse).' },
      { type: 'note', texte: 'Ce plan servira de base au mapping de la balance lors de l’import dans la mission.' },
      { type: 'h', texte: 'Modèles de documents' },
      { type: 'p', texte: 'Emplacement réservé aux lettres de mission, confirmations et rapports types (à venir).' },
    ],
  },
  {
    id: 'donnees',
  ...
  },
  {
    ...
    blocs: [
      { type: 'liste', items: [
        ...
        'Contenu de la page de mission (travaux de la mission).',
